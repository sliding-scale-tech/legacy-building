...
export function RecentJournalCard({
	...
	return (
		<div className={cn("flex w-full max-w-[300px] flex-col", className)}>
			...
			<button
				...
				className={cn(
					"flex w-full cursor-pointer flex-col overflow-hidden rounded-xl bg-white text-left",
					"shadow-[2px_2px_4px_0px_rgba(166,166,166,0.35)]",
					"transition-shadow hover:shadow-[2px_4px_8px_0px_rgba(166,166,166,0.4)]",
				)}
			>
				<ImageCarousel imageUrls={slideImageUrls} alt={title} />
